...
**Student ID Number:** \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
*Use stratified random sampling to ensure representation across key subgroups of office workers — such as age, gender, industry, and company size. Within each stratum, randomly select participants to invite into the study.*

*This method minimizes selection bias by ensuring that all relevant subgroups of the office worker population in Christchurch are proportionally represented. It also improves generalisability of the study results by reflecting the diversity of the population, rather than relying on convenience or voluntary samples.*
